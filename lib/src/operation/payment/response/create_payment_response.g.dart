...
CreatePaymentResponse _$CreatePaymentResponseFromJson(Map<String, dynamic> json) => CreatePaymentResponse(
      ...
      merchantCommissionRate: (json['merchantCommissionRate'] as num?)?.toDouble(),
      merchantCommissionRateAmount: (json['merchantCommissionRateAmount'] as num?)?.toDouble(),
      iyziCommissionRateAmount: (json['iyziCommissionRateAmount'] as num?)?.toDouble(),
      iyziCommissionFee: (json['iyziCommissionFee'] as num?)?.toDouble(),
      cardType: $enumDecodeNullable(_$CardTypeEnumMap, json['cardType']),
      cardAssociation: $enumDecodeNullable(_$CardAssociationEnumMap, json['cardAssociation']),
      ...
      itemTransactions:
          (json['itemTransactions'] as List<dynamic>?)?.map((e) => e == null ? null : ItemTransaction.fromJson(e as Map<String, dynamic>)).toList(),
...
Map<String, dynamic> _$CreatePaymentResponseToJson(CreatePaymentResponse instance) {
  ...
  writeNotNull('merchantCommissionRateAmount', instance.merchantCommissionRateAmount);
  ...
  writeNotNull('cardAssociation', _$CardAssociationEnumMap[instance.cardAssociation]);
...
ItemTransaction _$ItemTransactionFromJson(Map<String, dynamic> json) => ItemTransaction(
      ...
      blockageRateAmountMerchant: (json['blockageRateAmountMerchant'] as num?)?.toDouble(),
      blockageRateAmountSubMerchant: json['blockageRateAmountSubMerchant'] as int?,
      ...
      convertedPayout: json['convertedPayout'] == null ? null : ConvertedPayout.fromJson(json['convertedPayout'] as Map<String, dynamic>),
    );
...
Map<String, dynamic> _$ItemTransactionToJson(ItemTransaction instance) {
  ...
  writeNotNull('blockageRateAmountMerchant', instance.blockageRateAmountMerchant);
  writeNotNull('blockageRateAmountSubMerchant', instance.blockageRateAmountSubMerchant);
...
ConvertedPayout _$ConvertedPayoutFromJson(Map<String, dynamic> json) => ConvertedPayout(
      paidPrice: (json['paidPrice'] as num?)?.toDouble(),
      iyziCommissionRateAmount: (json['iyziCommissionRateAmount'] as num?)?.toDouble(),
      iyziCommissionFee: (json['iyziCommissionFee'] as num?)?.toDouble(),
      blockageRateAmountMerchant: (json['blockageRateAmountMerchant'] as num?)?.toDouble(),
      blockageRateAmountSubMerchant: (json['blockageRateAmountSubMerchant'] as num?)?.toDouble(),
      subMerchantPayoutAmount: (json['subMerchantPayoutAmount'] as num?)?.toDouble(),
      merchantPayoutAmount: (json['merchantPayoutAmount'] as num?)?.toDouble(),
