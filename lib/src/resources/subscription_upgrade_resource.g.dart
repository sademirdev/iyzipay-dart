...
part of 'subscription_upgrade_resource.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SubscriptionUpgradeResource _$SubscriptionUpgradeResourceFromJson(
        Map<String, dynamic> json) =>
    SubscriptionUpgradeResource(
      status: $enumDecodeNullable(_$IyzipayStatusEnumMap, json['status']),
      locale: $enumDecodeNullable(_$IyzipayLocaleEnumMap, json['locale']),
      systemTime: json['systemTime'] as int?,
      conversationId: json['conversationId'] as String?,
      subscriptionUpgradeData: json['data'] == null
          ? null
          : SubscriptionUpgradeData.fromJson(
...
Map<String, dynamic> _$SubscriptionUpgradeResourceToJson(
    SubscriptionUpgradeResource instance) {
  ...
  writeNotNull('data', instance.subscriptionUpgradeData);
  return val;
}
