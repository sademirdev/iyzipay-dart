...
part of 'iyzi_link_resource.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

IyziLinkResource _$IyziLinkResourceFromJson(Map<String, dynamic> json) =>
    IyziLinkResource(
      ...
      data: json['data'] == null
          ? null
          : IyziLinkItem.fromJson(json['data'] as Map<String, dynamic>),
      errorCode: json['errorCode'] as String?,
      errorMessage: json['errorMessage'] as String?,
      errorGroup: json['errorGroup'] as String?,
    );

Map<String, dynamic> _$IyziLinkResourceToJson(IyziLinkResource instance) {
