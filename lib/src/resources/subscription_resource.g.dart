...
part of 'subscription_resource.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SubscriptionResource _$SubscriptionResourceFromJson(
...
Map<String, dynamic> _$SubscriptionResourceToJson(
  ...
  writeNotNull('data', instance.subscriptionData);
  return val;
}
