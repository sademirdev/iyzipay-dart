...
part of 'subscription_product_resource.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SubscriptionProductResource _$SubscriptionProductResourceFromJson(
    ...
    SubscriptionProductResource(
      ...
      subscriptionProductData: json['data'] == null
          ? null
          : SubscriptionProductData.fromJson(
...
Map<String, dynamic> _$SubscriptionProductResourceToJson(
    SubscriptionProductResource instance) {
  ...
  writeNotNull('data', instance.subscriptionProductData);
  return val;
}
