...
part of 'subscription_customer_resource.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SubscriptionCustomerResource _$SubscriptionCustomerResourceFromJson(
        Map<String, dynamic> json) =>
    SubscriptionCustomerResource(
      status: $enumDecodeNullable(_$IyzipayStatusEnumMap, json['status']),
      locale: $enumDecodeNullable(_$IyzipayLocaleEnumMap, json['locale']),
      systemTime: json['systemTime'] as int?,
      conversationId: json['conversationId'] as String?,
      subscriptionCustomerData: json['data'] == null
          ? null
          : SubscriptionCustomerData.fromJson(
...
Map<String, dynamic> _$SubscriptionCustomerResourceToJson(
    SubscriptionCustomerResource instance) {
  ...
  writeNotNull('data', instance.subscriptionCustomerData);
  return val;
}
